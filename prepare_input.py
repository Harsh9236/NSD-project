def combine_text_files(file1_path, file2_path, output_file_path):
    ...
    try:
        with open(file1_path, 'r') as file1, open(file2_path, 'r') as file2, open(output_file_path, 'w') as output_file:
            ...
            output_file.write("Compare the job description and the resume and rate the suitability of the candidate on a scale of 1 to 10. Enclose the rating within angled brackets. For example: Rating <7>\n\n")
