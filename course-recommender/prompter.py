...
if __name__ == "__main__":
    ...
    prompt = "Compare the resume with the person's desired job and suggest skills that they should work on. Enclose the skills withing angled brackets. For example: <Git>, <React>, <Django>"
